...
результат поиска:   
![](img/resultSearch.jpg)   

результат генерации вычисления:   
![](img/calculatorResult.jpg)   

генерация почтового ящика: 
![](img/generationEmail.jpg)   

проверка почты, на которую пришла сгенерированная заявка:   
![](img/checkingMailBox.jpg)    

тестирование поставленной задачи:   
![](img/allTestsArePassed.jpg)
